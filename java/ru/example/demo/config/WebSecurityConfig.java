...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests()
					...
					.antMatchers("/section/update/**").hasAnyAuthority("EDITOR", "ADMIN")
					.antMatchers("/section/add/**").hasAnyAuthority("CREATOR", "ADMIN")
					.antMatchers("/section/delete/**").hasAnyAuthority("ADMIN")
					.antMatchers("/adminPage/**").hasAnyAuthority("ADMIN")
					.antMatchers("/section/products/**").hasAnyAuthority("USER", "CREATOR", "EDITOR", "ADMIN")
					.antMatchers("/section/products/add/**").hasAnyAuthority("CREATOR", "ADMIN")
					.antMatchers("/section/products/delete/**").hasAnyAuthority("ADMIN") 
					.antMatchers("/section/products/update/**").hasAnyAuthority("EDITOR", "ADMIN")										
